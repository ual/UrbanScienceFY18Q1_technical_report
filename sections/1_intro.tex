...
%\todo{From Emily: I'm not sure if I like this reference to dynamic equilibrium because it's totally unrelated to the static equilibrium we define later on but just from the words "dynamic equilibrium" it seems like it should be related }
%In short, the urban system is in a state of dynamic equilibrium, and when the equilibrium is perturbed, the agents in the system react to restore equilibrium. If faster travel times are available to reach desired destinations, people will find them.
